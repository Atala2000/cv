...
/**
 * help_all - Displays all possible builtin my cmds.
 */
void help_all(void)
{
...
/**
 * help_alias - Displays information on the my builtin cmd 'alias'.
 */
void help_alias(void)
{
...
/**
 * help_cd - Displays information on the my builtin cmd 'cd'.
 */
void help_cd(void)
{
...
/**
 * help_exit - Displays information on the my builtin cmd 'exit'.
 */
void help_exit(void)
{
...
/**
 * help_help - Displays information on the my builtin cmd 'help'.
 */
void help_help(void)
{
	char *msg = "help: help\n\tSee all possible my builtin cmds.\n";
