...
/**
 * free_ars - Frees up memory taken by ars.
 * @ars: A null-terminated double pointer containing cmds/arguments.
 ...
 * @exe_ret: A pointer to the return value of the last executed cmd.
 *
